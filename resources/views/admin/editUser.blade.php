...
<head>
    ...
    <title>{{ page_title($title ?? 'Mise à jour de compte') }}</title>
    ...
    <div class="card-body register-card-body">
      ...
      <form  method="POST" action="{{ route('admin.updateUser') }}">
        ...
        <div class="input-group mb-3">
          <input type="text" name="name" class="form-control" value="{{ old('name') ?: $user->name }}" placeholder="Nom d'utilisateur">
        ...
        <div class="row">
          ...
          <!-- /.col -->
            <button type="submit" class="btn btn-primary btn-block btn-flat">Mise à jour de mon compte</button>
